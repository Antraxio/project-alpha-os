...
export const I18N={
  de:{
    ...
    marketRegime:'MARKTREGIME',trend:'Trend',breadth:'Breite',stance:'Haltung',attentionToday:'Was heute Aufmerksamkeit verdient',partialProfitNear:'Teilgewinn fast erreicht',strategyLink:'Strategie →',watchlist:'WATCHLIST',largestChanges:'Größte Veränderungen',timelineLink:'Timeline →',completeRanking:'Vollständige Rangliste',openUniverse:'Universe 50 →',watchlistPosition:'Rang',securities:'Werte',
  ...
  en:{
    ...
    marketRegime:'MARKET REGIME',trend:'Trend',breadth:'Breadth',stance:'Stance',attentionToday:'What deserves attention today',partialProfitNear:'Partial-profit target is close',strategyLink:'Strategy →',watchlist:'WATCHLIST',largestChanges:'Largest changes',timelineLink:'Timeline →',completeRanking:'Complete ranking',openUniverse:'Universe 50 →',watchlistPosition:'Rank',securities:'securities',
