...
export const I18N={
  de:{
    ...
    subnavOverview:'Übersicht',subnavComparison:'Vergleich',subnavHistory:'Historie',subnavRanking:'Ranking',subnavUniverse:'Universum',subnavResearch:'Research-Status',subnavTimeline:'Verlauf',subnavStrategy:'Strategieprofil',subnavMethodology:'So funktioniert das Modell',
    ...
    executiveEyebrow:'TAGESÜBERBLICK',decisionEyebrow:'EINZELANALYSE',scannerEyebrow:'CHANCEN',timelineEyebrow:'CHANCEN',portfolioEyebrow:'DEPOT',competitionEyebrow:'DEPOT',journalEyebrow:'DEPOT',methodologyEyebrow:'MODELL & EINSTELLUNGEN',settingsEyebrow:'MODELL & EINSTELLUNGEN',
  ...
  en:{
    ...
    subnavOverview:'Overview',subnavComparison:'Comparison',subnavHistory:'History',subnavRanking:'Ranking',subnavUniverse:'Universe',subnavResearch:'Research status',subnavTimeline:'History',subnavStrategy:'Strategy profile',subnavMethodology:'How the model works',
    ...
    executiveEyebrow:'DAILY OVERVIEW',decisionEyebrow:'SECURITY ANALYSIS',scannerEyebrow:'OPPORTUNITIES',timelineEyebrow:'OPPORTUNITIES',portfolioEyebrow:'PORTFOLIO',competitionEyebrow:'PORTFOLIO',journalEyebrow:'PORTFOLIO',methodologyEyebrow:'MODEL & SETTINGS',settingsEyebrow:'MODEL & SETTINGS',
