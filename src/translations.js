...
export const I18N={
  de:{
    ...
    subnavOverview:'Übersicht',subnavHistory:'Historie',subnavRanking:'Ranking',subnavUniverse:'Universum',subnavResearch:'Research-Status',subnavTimeline:'Verlauf',subnavStrategy:'Strategieprofil',subnavMethodology:'So funktioniert das Modell',subnavModelHistory:'Änderungsverlauf',
    ...
    marketRegime:'MARKTREGIME',trend:'Trend',breadth:'Breite',stance:'Haltung',attentionToday:'Was heute Aufmerksamkeit verdient',strategyLink:'Strategie →',watchlist:'CHANCEN',largestChanges:'Größte Veränderungen',timelineLink:'Verlauf →',completeRanking:'Top 3 Chancen',openUniverse:'Alle Chancen →',watchlistPosition:'Rang',securities:'Werte',
    ...
    executiveEyebrow:'TAGESÜBERBLICK',decisionEyebrow:'EINZELANALYSE',scannerEyebrow:'CHANCEN',timelineEyebrow:'CHANCEN',portfolioEyebrow:'DEPOT',journalEyebrow:'DEPOT',methodologyEyebrow:'MODELL & EINSTELLUNGEN',settingsEyebrow:'MODELL & EINSTELLUNGEN',modelHistoryEyebrow:'MODELL & EINSTELLUNGEN',
    projectAlpha:'Dashboard',decisionLab:'Analyse',scannerTitle:'Ranking',timelineTitle:'Verlauf',portfolioTitle:'Übersicht',journalTitle:'Historie',methodologyTitle:'So funktioniert das Modell',settingsTitle:'Strategieprofil',
    ...
    portfolioValue:'Depotwert',totalAssets:'Gesamtvermögen',activeCash:'Aktives Cash',openProfit:'Offener Buchgewinn',closedTrade:'Trade',closedTradesLabel:'Trades',cashReconciled:'Kasse abgestimmt',cashUnreconciled:'Kassendifferenz zur Bank',bankStatement:'Bankbeleg',cashQuote:'Cashquote',
    ...
    staleDecisionKicker:'LETZTE BEWERTUNG · VERALTET',staleNoTrigger:'Kein aktueller Trigger – der Snapshot ist veraltet.',staleNoSizing:'Keine Stückzahl-Empfehlung aus veralteten Kursen.',staleNoLadder:'Aus einem veralteten Snapshot werden keine Ausführungsschritte abgeleitet.',staleHistoric:'historisch',noStopRecorded:'kein Stop hinterlegt',withoutStop:'Ohne hinterlegten Stop',ofPositions:'von',proceeds:'Erlös',staleZoneHidden:'Abstand ausgeblendet',noIncumbent:'kein Bestand zu schlagen',legacyBasis:'Altbestand',legacyBasisShort:'ALT',dossierBasis:'Dossier',legacyBasisExplain:'Bewertung beruht auf der übernommenen Ausnahme aus v0.6.0, nicht auf einem freigegebenen Dossier.',dossierBasisExplain:'Bewertung beruht auf einem freigegebenen Dossier mit vollständiger Checkliste.',legacyMigrationTitle:'RESEARCH-GOVERNANCE',legacyMigrationHead:'Worauf beruhen die Bewertungen?',legacyMigrationProgress:'Auf Dossier migriert',legacyMigrationOpen:'Noch auf Altbestands-Ausnahme',legacyMigrationDone:'Alle bewerteten Titel beruhen auf einem freigegebenen Dossier.',
    ...
    activePositions:'AKTIVE POSITIONEN',noOpenPositions:'Keine offene Position',noOpenPositionsText:'Das Depot hält aktuell ausschließlich Cash. Kennzahlen zu Positionen, Aufteilung und Stop-Risiko erscheinen, sobald eine Position eröffnet ist.',noClosedTrades:'Keine abgeschlossenen Trades',positionFocus:'POSITION IM FOKUS',closestToTarget:'Am nächsten an Ziel 1',noTargetPosition:'Keine Position mit hinterlegtem Ziel',countryInvested:'Land, nur investiert',sectorInvested:'Sektor, nur investiert',acrossPositions:'über alle Positionen',aggregated:'aggregiert',
    ...
    positions:'Positionen',position:'Position',custom:'INDIVIDUELL',standard:'STANDARD',
  ...
  en:{
    ...
    subnavOverview:'Overview',subnavHistory:'History',subnavRanking:'Ranking',subnavUniverse:'Universe',subnavResearch:'Research status',subnavTimeline:'History',subnavStrategy:'Strategy profile',subnavMethodology:'How the model works',subnavModelHistory:'Change log',
    ...
    marketRegime:'MARKET REGIME',trend:'Trend',breadth:'Breadth',stance:'Stance',attentionToday:'What deserves attention today',strategyLink:'Strategy →',watchlist:'OPPORTUNITIES',largestChanges:'Largest changes',timelineLink:'History →',completeRanking:'Top 3 opportunities',openUniverse:'All opportunities →',watchlistPosition:'Rank',securities:'securities',
    ...
    transactionHistory:'Transaction history',transactionHistoryIntro:'Confirmed purchases, open positions and closed trades only.',modelChangeHistory:'Change log',modelChangeHistoryIntro:'Product, methodology and strategy changes — separate from the portfolio.',transactions:'Transactions',openPositions:'Open positions',realisedResult:'Realised result',statusOpen:'Open',
    ...
    executiveEyebrow:'DAILY OVERVIEW',decisionEyebrow:'SECURITY ANALYSIS',scannerEyebrow:'OPPORTUNITIES',timelineEyebrow:'OPPORTUNITIES',portfolioEyebrow:'PORTFOLIO',journalEyebrow:'PORTFOLIO',methodologyEyebrow:'MODEL & SETTINGS',settingsEyebrow:'MODEL & SETTINGS',modelHistoryEyebrow:'MODEL & SETTINGS',
    projectAlpha:'Dashboard',decisionLab:'Analysis',scannerTitle:'Ranking',timelineTitle:'History',portfolioTitle:'Overview',journalTitle:'History',methodologyTitle:'How the model works',settingsTitle:'Strategy profile',
    ...
    portfolioValue:'Portfolio value',totalAssets:'Total assets',activeCash:'Active cash',openProfit:'Open profit',closedTrade:'trade',closedTradesLabel:'trades',cashReconciled:'Cash reconciled',cashUnreconciled:'Cash differs from bank',bankStatement:'Bank statement',cashQuote:'Cash ratio',
    ...
    staleDecisionKicker:'LAST ASSESSMENT · STALE',staleNoTrigger:'No current trigger — the snapshot is stale.',staleNoSizing:'No share-count recommendation from stale prices.',staleNoLadder:'No execution steps are derived from a stale snapshot.',staleHistoric:'historical',noStopRecorded:'no stop recorded',withoutStop:'Without a recorded stop',ofPositions:'of',proceeds:'Proceeds',staleZoneHidden:'Distance hidden',noIncumbent:'no holding to beat',legacyBasis:'Inherited',legacyBasisShort:'LEG',dossierBasis:'Dossier',legacyBasisExplain:'Ranked under the inherited v0.6.0 exception, not on an approved dossier.',dossierBasisExplain:'Ranked on an approved dossier with a complete checklist.',legacyMigrationTitle:'RESEARCH GOVERNANCE',legacyMigrationHead:'What are the ratings based on?',legacyMigrationProgress:'Migrated to a dossier',legacyMigrationOpen:'Still on the inherited exception',legacyMigrationDone:'Every scored security rests on an approved dossier.',
    ...
    activePositions:'ACTIVE POSITIONS',noOpenPositions:'No open position',noOpenPositionsText:'The portfolio currently holds cash only. Position, allocation and stop-risk figures appear once a position is opened.',noClosedTrades:'No closed trades',positionFocus:'POSITION IN FOCUS',closestToTarget:'Closest to target 1',noTargetPosition:'No position with a recorded target',countryInvested:'Country, invested only',sectorInvested:'Sector, invested only',acrossPositions:'across all positions',aggregated:'aggregated',
    ...
    positions:'positions',position:'position',custom:'CUSTOM',standard:'STANDARD',
